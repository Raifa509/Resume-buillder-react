...
function LandingPage() {
  return (
    <>
    <section className='container-fluid' style={{backgroundImage:"url('https://i0.wp.com/www.cpasitesolutions.com/cpa-websites/wp-content/uploads/2024/06/local-seo-for-bookeepers-1.png?fit=2240%2C1260&ssl=1')",backgroundPosition:'top',backgroundAttachment:'fixed',backgroundSize:'cover',height:'36rem'}}>
      <div className="row h-100 d-flex justify-content-center align-items-center">
        <div className="col-12 col-md-4"></div>
        <div className=" text-center p-5 col-12 col-md-4 box border rounded" style={{backgroundColor:'rgb(225,225,225,0.4)'}}>
          <h3>Designed to get hired.</h3>
            <h4>Your skills,your story,your next job — all in one.</h4>
            <Link to={'/resume'}><button className="btn mt-3 text-light px-3 py-2" style={{backgroundColor:'#053d63ff'}}>Make your resume</button></Link>
        </div>
        <div className="col-12 col-md-4"></div>
      </div>
    </section>
    ...
    <section className='p-4'>
      <h2 className='text-center py-4'>Tools</h2>
    ...
    {/* background */}
      <section className='container-fluid' style={{backgroundImage:"url('https://t3.ftcdn.net/jpg/06/09/63/32/360_F_609633201_i0vmYIwqzwxXPnD9vzEVO3nj4noZTKHA.jpg')",backgroundAttachment:'fixed',backgroundSize:'cover',height:'36rem'}}>
      </section>
      <section className='p-4'>
        <div className="row">
 ...
 <div className='row align-items-center p-5'>
            <div className="col-12 col-md-6 p-5">
            <h4 className='py-4 '>Trusted by professionals worldwide.</h4>
